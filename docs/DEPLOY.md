...
4. Before first deploy completes, open **api-saidas-backend** → **Environment** and set:
   ...
   `SECRET_KEY` is auto-generated. `CORS_ORIGIN_REGEX` is preset for Vercel previews.
...
| Backend crash on start | Set valid `ENCRYPTION_KEY` |
